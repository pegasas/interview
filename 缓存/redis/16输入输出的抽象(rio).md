...
rio结构体如下：[rio.c 和 rio.h 文件详细注释](https://github.com/menwengit/redis_source_annotation)
```
struct _rio {
	/* Backend functions.
...
static size_t rioFdsetWrite( rio *r, const void *buf, size_t len )
{
	...
	if ( doflush )
		sdsclear( r->io.fdset.buf );    /* 释放集合缓冲区 */
	return(1);
}
